...
def fail(account, msg="Invalid", title="", info="FAILED"):
	print("[\033[31m-\033[00m] [\033[31m%s\033[00m] [\033[34m%s\033[00m] --> [\033[37m%s\033[00m] %s" % (
	info, msg, title, account))


def found(user, passwd, title):
	print(
		"[\033[37m*\033[00m] [\033[36mMATCH\033[00m] ['\033[32m%s\033[00m':'\033[32m%s\033[00m'] [\033[37m%s\033[00m]" % (
		user, passwd, title))
